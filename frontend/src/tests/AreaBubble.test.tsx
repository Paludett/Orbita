...
describe("AreaBubble", () => {
  ...
  it("renders area name", () => {
    render(<AreaBubble area={AREA} index={0} onEdit={jest.fn()} onDelete={jest.fn()} />);
  ...
  it("calls onDelete with area id on confirm", () => {
    ...
    render(<AreaBubble area={AREA} index={0} onEdit={jest.fn()} onDelete={onDelete} />);
    fireEvent.mouseEnter(screen.getByTestId("area-bubble"));
    fireEvent.click(screen.getByLabelText("Deletar área"));
  ...
  it("calls onEdit with area on edit click", () => {
    ...
    render(<AreaBubble area={AREA} index={0} onEdit={onEdit} onDelete={jest.fn()} />);
    fireEvent.mouseEnter(screen.getByTestId("area-bubble"));
